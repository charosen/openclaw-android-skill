...
|------|------|
| **JDK** | JDK 17+ |
| **Android SDK** | 通过 Android Studio 安装，或手动下载 |
| **Gradle** | 项目自带 (gradlew) |
...
**手动安装 Android SDK**（如果不用 Android Studio）：

```bash
# 1. 下载 command line tools
mkdir -p ~/android-sdk/cmdline-tools
cd ~/android-sdk/cmdline-tools
curl -o cmdline-tools.zip https://dl.google.com/android/repository/commandlinetools-mac-arm64_latest.zip
